                  ...
                  <Box>
                    ...
                    <p>Smart contract at: {
                      (
                        this.state.netId === 4 ?
                        (
                          <a href={`https://rinkeby.etherscan.io/token/${this.state.itoken.options.address}`}>{this.state.itoken.options.address}</a>
                        ) :
                        (
                          this.state.netId === 54 &&
                          (
                            <a href={`https://bscscan.com/token/${this.state.itoken.options.address}`}>{this.state.itoken.options.address}</a>
                          )
                        )
                      )
                    }</p>
